...
barscanner0 = InputDevice('/dev/barscanner0')
barscanner1 = InputDevice('/dev/barscanner1')

selector.register(barscanner0, selectors.EVENT_READ)
selector.register(barscanner1, selectors.EVENT_READ)
